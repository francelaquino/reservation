...
<div class="page-content-inner" id="partnerController" ng-controller="partnerController" ng-init="initMemberForm();getmember()" >
            <div class="portlet  ">
            <div class="portlet-title ">
                    <div class="caption caption-md">
                        <span class="captin-subject font-blue-madison  uppercase">Update Member Information</span>
                ...
                <div class="portlet-body  " >
                    ...
                    <span class="captin-subject font-red-sunglo  " style="margin-bottom: 10px;">Employment Details</span>
                        ...
                        <div class="row">
                         ...
                         <div class="col-md-4 enddate"  ng-show="members.employeestatus=='2'">
                                            <div class="form-group">
 ...
 $('.datepicker').datetimepicker({
        ...
        $('#member_form').bootstrapValidator({
            submitHandler: function (validator, form, submitButton) {
                angular.element(document.getElementById('partnerController')).scope().updateMemberInfo();
