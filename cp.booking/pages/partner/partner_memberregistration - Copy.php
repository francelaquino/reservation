        ...
        <div class="portlet-body form " >
            ...
            <div class="form-body" style="padding-bottom: 0px">
                <div class="row " style="margin-bottom: 10px;">
                    <div class="col-md-4">
                        <span class="captin-subject font-red-sunglo  uppercase" style="margin-bottom: 10px">Required Information<span>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                    ...
                    <div class="portlet  ">
                        <div class="portlet-body form" >
                            ...
                            <div class="form-body" style="padding-bottom: 0px">
                                <div class="row " style="margin-bottom: 10px;">
                                    <div class="col-md-12">
                                        <span class="captin-subject font-red-sunglo  uppercase" style="margin-bottom: 10px">Proof of Identify<span>
                                        </div>
                                    </div>
                                                ...
                                                <tbody>
                                                    <tr ng-repeat="document in documents" >
                                                        ...
                                                        <td >
                                                            ...
                                                            <button  ng-show="document.filename!=''" type="button" ng-click="removeFile(document.docid,document.memberid,document.filename)" class="btn btn-xs red btn-primary filter-submit margin-bottom btnPrepareUpload">
                            ...
                            <div class="form-actions text-right">
                                <hr/>
                                <button type="button" class="btn default" ng-click="goBackValidID()">
