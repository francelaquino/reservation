								...
								<div class="row">
									<div class="col-md-4">
										<div class="form-group">
											...
											<select class="form-control" name="loanplan" ng-model="members.loantype">
									...
									<div class="col-md-4" >
										<div class="form-group">
											...
											<input type="number" class="form-control" maxlength="100"  name="loanamount" ng-model="members.principal">
										</div>
									</div>
									<div class="col-md-4" ng-show="members.loantype=='B'">
										<div class="form-group">
...
<div class="portlet-body  ready" ng-show="steps.step4">
