    ...
    <div class="portlet  ">
        ...
        <div class="row">
            ...
            <div class="page-content-inner loanpayplus" style="margin-top: 100px;display: none; color:white">
                <div class="col-md-12 text-center">
                    <h4>You are not allowed to request payplus if you still have outstanding balance.</h4>
                </div>
            </div>
            ...
            <div class="portlet " style="display: none">
                <div class="col-md-12 loanrequest" style="margin-top: 50px; margin-bottom: 20px;">
                    <div class="text-center">
                        <a href="javascript:void(0)" id='btnpaynow' ng-click="showPlan('A')" class="active btn-loan-curve ">Pay<span style="color:#5fd282;font-style: italic;font-weight: normal; ">Now</span></a>
                        <a href="javascript:void(0)" id='btnpayexpress' ng-click="showPlan('B')" class="btn-loan-curve">Pay<span style="color:#f6cf68;font-style: italic;font-weight: normal; ">MeExpress</span></a>
                        <a href="javascript:void(0)" id='btnpayplus' ng-click="showPlan('C')" class="btn-loan-curve">Pay<span style="color:#1154a7;font-style: italic;font-weight: normal; ">Plus</span></a>

                        <div id='paynowplan' ng-include="'pages/member/member_paynowplan.php'"></div>
                        <div id='paymeexpressplan' style='display:none' ng-include="'pages/member/member_paymeexpressplan.php'"></div>
                        <div id='payplusplan' style='display:none' ng-include="'pages/member/member_payplusplan.php'"></div>
                ...
                <div class="container loanrequest">
                    <div id="summary" class="col-md-12 text-center " style="display: none">
                        ...
                        <div class="portlet-body  ">
                            <div class="form-body ">
                                ...
                                <div class="container-round ">
                                    ...
                                    <input type="text" class="form-control input-circle" readonly ng-model="loan.cashreceived">
                                </div>
                        ...
                        <div class=" col-md-12 " style="margin-top: 10px;">
                            ...
                            <button type="button" class="btn btn-warning" ng-click="savePayPlusApplication()">Submit</button>
