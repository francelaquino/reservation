...
<div class="page-content-inner"   id="memberController" ng-controller="memberController" ng-init="initLoanForm('A');">
    <div class="portlet  ">
            ...
            <div class="portlet " style="display: none">
                <div class="col-md-12 loanrequest" style="margin-top: 50px; margin-bottom: 20px;" >
                    <div class="text-center">
                        <a  href="#/member/paynow" class="active btn-loan-curve ">Pay<span style="color:#5fd282;font-style: italic;font-weight: normal; ">Now</span></a>
                        <a  href="#/member/paymeexpress" class="btn-loan-curve">Pay<span style="color:#f6cf68;font-style: italic;font-weight: normal; ">MeExpress</span></a>
                        <a  href="#/member/payplus" class="btn-loan-curve">Pay<span style="color:#1154a7;font-style: italic;font-weight: normal; ">Plus</span></a>
                        
                        <div id="initialsummary" style="display: none">
                            <h5>Access your pay as you earn it or for days you have actually worked.</h5>
                            <h3>Enter Amount</h3>
                            <input type="number" class="form-control input-circle text-center" style="width: 200px;font-weight: bold; font-size: 19px; margin:auto"  ng-model="loan.loanamount"><br>
                            <h3  style="color:silver">Php. {{estimatedSalary | number:2}}</h3>
                            <h5 style="color:silver;margin: 0px;">(
                            Your estimated earned income to date)</h5><br>
                            ...
                            <div class="container-round " style="width: 500px;padding: 15px; height: 90px">
                                ...
                                <p style="text-align: justify;margin: 0px;margin-bottom: 10px;">Important Reminder: Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor   incididunt ut labore et dolore magna aliqua.</p>
                                <p style="text-align: justify;margin: 0px;"><input type="checkbox" id="terms"> Ticking this box means you agree and understand to the terms stated.</p>
                                </h5>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container loanrequest" >
                    <div id="summary" class="col-md-12 text-center " style="display: none" >
                        ...
                        <div class=" col-md-12 " style="margin-top: 10px;">
                            ...
                            <button type="button"  class="btn btn-warning" ng-click="savePayNowApplication('A')">Submit</button>
