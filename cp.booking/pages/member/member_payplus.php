...
<div class="page-content-inner" id="memberController" ng-controller="memberController" ng-init="initLoanForm('C')">
            ...
            <div class="portlet " style="display: none">
                <div class="col-md-12 loanrequest" style="margin-top: 50px; margin-bottom: 20px;">
                    <div class="text-center">
                        ...
                        <a href="#/member/payplus" class="active btn-loan-curve">Pay<span style="color:#1154a7;font-style: italic;font-weight: normal; ">Plus</span></a>
                        <div id="initialsummary">
                            <h5>Customize your PayPlus that works for you!</h5>
                            <div class="col-md-8 " style=" margin: auto; clear: both;float: none">
                                ...
                                <div class="col-md-6" style="padding: 0px;">
                                    <h5 style="line-height: 40px;display: inline-block; width: 350px;float: right;padding: 0px; text-align: right;">Enter Amount <input id="loanamount" type="number" class="form-control input-circle text-center"
                                            style="width: 150px; font-size: 15px; display: inline-block;" ng-change="updateLoanSlider()"
                                            ng-model="loan.loanamount"></h5>
                                </div>
                            </div>
