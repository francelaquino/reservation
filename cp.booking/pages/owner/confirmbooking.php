<div class="portlet light bordered " id="ownerController" ng-controller="ownerController" ng-init="getConfirmedProperties()" >
    <div class="portlet-body  ">

        <div class="form-body">
            <h1 class="form-title">Confirmed Booking</h1>
            <div class="row" style="margin-bottom: 10px;">
                        ...
                        <div class="col-md-3">
                            <button type="button" class="btn btn-default" ng-click="getConfirmedProperties()"  >
                            Search</button>
                        ...
                        <h5 class="title">Confirmed Booking Reports</h5>
