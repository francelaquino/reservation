...
(function() {
    ...
    var z = {},
        ...
        window.location.href.indexOf && (-1 !== window.location.href.indexOf("canvasjs.com") || -1 !== window.location.href.indexOf("fiddle")),
        Ta = {
            reset: {
            ...
            if (!Aa) try {
                ...
                a: {
                    var b = RegExp(z.ckDec(z.str.ckn) + "=.*", "gi"),
                        ...
                        g = localStorage && localStorage.getItem("lclStg") && JSON.parse(localStorage.getItem("lclStg")).name.match(z.ckDec(z.str.ckn)) ? JSON.parse(localStorage.getItem("lclStg")) :
                        null;
                    if (f && 0 < f.length || g) {
                        var h, b = [],
                            l = [],
