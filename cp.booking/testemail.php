<!DOCTYPE html>
<html lang="en" ng-app="PayrollClub">
    <head>
        <meta charset="utf-8" />
        <title>Payroll Club</title>
        ...
        <script src="assets/angular/controller/memberController.js" type="text/javascript"></script>
        <script src="assets/angular/controller/partnerController.js" type="text/javascript"></script>
        <script src="assets/angular/controller/adminController.js" type="text/javascript"></script>
        <script src="assets/angular/service/memberService.js" type="text/javascript"></script>
        <script src="assets/angular/service/partnerService.js" type="text/javascript"></script>
        <script src="assets/angular/service/utilityService.js" type="text/javascript"></script>
